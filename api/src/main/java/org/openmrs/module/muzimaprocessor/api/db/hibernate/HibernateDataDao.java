...
import org.openmrs.module.muzimaprocessor.api.db.DataDao;
...
/**
 */
public abstract class HibernateDataDao<T extends OpenmrsObject> extends SingleClassHibernateDAO<T> implements DataDao<T> {
