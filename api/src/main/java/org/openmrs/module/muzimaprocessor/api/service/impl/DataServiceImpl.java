 ...
 */
package org.openmrs.module.muzimaprocessor.api.service.impl;
...
import org.openmrs.module.muzimaprocessor.api.db.ErrorDataDao;
...
import org.openmrs.module.muzimaprocessor.model.ErrorData;
...
public class DataServiceImpl extends BaseOpenmrsService implements DataService {
    ...
    public DataSource getDataSource(final Integer id) {
        return getDataSourceDao().getData(id);
    }
    ...
    public List<DataSource> getAllDataSource() {
        return getDataSourceDao().getAllData();
    }
    ...
    public DataSource saveDataSource(final DataSource dataSource) {
        return getDataSourceDao().saveData(dataSource);
    }
    ...
    public void purgeDataSource(final DataSource dataSource) {
        getDataSourceDao().purgeData(dataSource);
    }
}
