...
public class DataServiceTest {
    ...
    /**
     * @verifies return null when no queue data with matching id.
     * @see DataService#getQueueData(Integer)
     */
    @Test
    ...
    /**
     * @verifies return null when no queue data with matching uuid.
     * @see DataService#getQueueDataByUuid(String)
     */
    @Test
    ...
    /**
     * @verifies return all saved queue data.
     * @see DataService#getAllQueueData()
     */
    @Test
    ...
    /**
     * @verifies return null when no error data with matching id.
     * @see DataService#getErrorData(Integer)
     */
    @Test
    ...
    /**
     * @verifies return null when no error data with matching uuid.
     * @see DataService#getErrorDataByUuid(String)
     */
    @Test
    ...
    /**
     * @verifies return all saved error data.
     * @see DataService#getAllErrorData()
     */
    @Test
    ...
    /**
     * @verifies return null when no archive data with matching id.
     * @see DataService#getArchiveData(Integer)
     */
    @Test
    ...
    /**
     * @verifies return null when no archive data with matching uuid.
     * @see DataService#getArchiveDataByUuid(String)
     */
    @Test
    ...
    /**
     * @verifies return null when no data source with matching id.
     * @see DataService#getDataSource(Integer)
     */
    @Test
    ...
    /**
     * @verifies return null when no data source with matching uuid.
     * @see DataService#getDataSourceByUuid(String)
     */
    @Test
    ...
    /**
     * @verifies return all saved data source.
     * @see DataService#getAllDataSource()
     */
    @Test
