...
public class WebConverter {
    ...
    public static Map<String, Object> convertQueueData(final QueueData queueData) {
        ...
        if (queueData != null) {
            ...
            map.put("locationId", queueData.getLocationId());
            map.put("locationName", queueData.getLocationName());
    ...
    public static Map<String, Object> convertErrorData(final ErrorData errorData) {
        ...
        if (errorData != null) {
            ...
            map.put("locationId", errorData.getLocationId());
            map.put("locationName", errorData.getLocationName());
